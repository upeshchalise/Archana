...
const SignUp = () => {
  return (
    <div className="flex flex-col items-center w-[19.5rem] max-h-full mx-auto ">
      <section className=" rounded-lg w-full h-max-full flex flex-col mt-10 pb-18 p-4 gap-4 z-40 opacity-100 bg-white shadow-customShadow">
        ...
        <Link href="/login">
          <button
            type="button"
            className="rounded-lg text-white w-full font-semibold p-2 mt-4 bg-[#1F8F2A]"
          >
            Sign Up
          </button>
        </Link>
